...
class IPythonUtils:
    ...
    def exec_python(cell: Annotated[str, "要執行的有效 Python 程式碼區塊"]) -> str:
        """
        在 IPython 中執行程式碼區塊並返回執行結果。
        """
        ipython = get_ipython()
...
class CodingUtils:  # 來源：https://microsoft.github.io/autogen/docs/notebooks/agentchat_function_call_code_writing
